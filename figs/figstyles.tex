...
%
%     fgBlue  #35618A   the learned / adopted path      (style.py "learned")
%     fgRed   #AF5551   the oracle and the failed claim (style.py "oracle")
...
\definecolor{fgBlue}{HTML}{35618A}
\definecolor{fgRed}{HTML}{AF5551}
